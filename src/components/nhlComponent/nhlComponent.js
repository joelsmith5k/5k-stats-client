...
function NhlComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen standardColors overflow-hidden py-4">
      ...
      <div className="flex flex-row">
        <div className="w-full mx-auto text-center py-4 px-2">
          <p>
            ...
            {nhlAggregates.num_players} players against 62 NHL goalies over 6
            seasons.
            <br></br>
            <br></br>
